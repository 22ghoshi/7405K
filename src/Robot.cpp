...
void Robot::moveDist(int dist) { //TODO tune values for forward
	double kP = 0.2;
	double kI = 0;
	double kD = 0.01;
	double P = 0, I = 0, D = 0;
...
void Robot::liftPID(void* params) { //TODO make lift pid
    double kP = 0;
	double kI = 0;
	double kD = 0;
	double P = 0, I = 0, D = 0;
...
void Robot::anglerPID(void* params) { //TODO make angler pid
    double kP = 0;
	double kI = 0;
	double kD = 0;
	double P = 0, I = 0, D = 0;
